...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-300">
      {/* Header */}
      <header className="bg-gradient-to-r from-blue-500 to-purple-500 shadow-smborder-b border-gray-300 py-4">
        <div className="max-w-4xl mx-auto px-4 py-6">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold text-white">Task Manager</h1>
              <p className="text-white mt-1">Simple task management</p>
            </div>
            <button
